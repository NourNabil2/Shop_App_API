...
import 'package:shop/Features/search/view/search.dart';
import '../../categorise/data/Model_Categories.dart';
import '../../main page/view model/states.dart';
...
class HomePage extends StatelessWidget {
  ...
  Widget buildGridView(HomeModelData model, NewsCubit cubit) {
    return SliverGrid(delegate: SliverChildListDelegate(
        ...
        ))), gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(crossAxisCount: 2 ,crossAxisSpacing: 1.0 ,mainAxisSpacing: 1.0, childAspectRatio: 1/2, )) ;
  }
